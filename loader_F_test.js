...
//     console.log("HJKHIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIIII");
//     if (err) {
...
,
  ...
  {"table_name":"Camera",
    "columns": [{"column_name":"sensor_id", "column_type":"integer", "primary_key":true},
                ...
                {"column_name": "location", "column_type": "text", "foreignkey": {"foreign_table":"Space", "foreign_column":"space_name"}},
                {"column_name":"output_type", "column_type":"text"},
                {"column_name": "resolution", "column_type": "text"}
               ]
  },
  {"table_name":"WifiAP",
    "columns": [{"column_name":"sensor_id", "column_type":"integer", "primary_key":true},
                ...
                {"column_name":"output_type", "column_type":"text"},
                {"column_name": "location", "column_type": "text", "foreignkey": {"foreign_table":"Space", "foreign_column":"space_name"}},
                {"column_name": "standard", "column_type": "text"},
                {"column_name": "protocol", "column_type": "text"}
               ]
  },
  {"table_name":"Staff",
    "columns": [{"column_name":"user_id", "column_type":"integer", "primary_key":true},
                ...
                {"column_name":"parent_type_name", "column_type":"text"},
                {"column_name": "start_date", "column_type": "date"},
...
// `${a}.tet khkj`
      ...
      //NEW
        ...
        metadata.forEach((mtd, key) => {
            ...
            //WIFFI
           else if (mtd.wifiaps) { //if it's a table
              //let table_name = mtd.table_name;
              let cameras = mtd.cameras;
              //start query string
            ...
            //space
            else if (mtd.spaces) { //if it's a table
              //let table_name = mtd.table_name;
              let cameras = mtd.spaces;
              //start query string
    ...
    let query1;
     ...
     const values = Object.values(value)
      ...
      query1 =" ";
			...
			query1 = query1 + "row ( "+column_name + ", "+column_type +")::coordinate[], ";
